"""[COALITION3] Correct the log file 'Training_Dataset_Processing_Status.pkl'
   after one run of the training dataset generation by resetting the entries
   'Processing=True' to 'Processing=False', which can then be processed again."""
...
print("\nThis script is used during the generation of the training dataset.\n \
